...
<body class="landing-body">
    ...
    <div class="landing-page-wrapper">
        ...
        <div class="main-content landing-main">
            ...
            <!-- Start:: Section-12 -->
            @include('frontend.footers.sash.footer1')
            <!-- End:: Section-12 -->

            <div class="text-center landing-main-footer py-3">
                <span class="text-muted fs-15"> Copyright ©
                    <span id="year"></span>
                    <a href="javascript:void(0);" class="text-primary fw-semibold">Company Name</a>. Designed by
                    <a href="javascript:void(0);" class="text-primary fw-semibold">Omar Munib</a> All rights reserved
                </span>
            </div>
        </div>
        <!-- End::app-content -->
